...
export function IconPeople() {
    return (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            <path d="M2 13.5c0-3.038 2.462-5.5 5.5-5.5s5.5 2.462 5.5 5.5" stroke="currentColor" strokeWidth="1.5"
                  strokeLinecap="round"/>
        </svg>
    )
}
...
export function IconClock() {
    return (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            <path d="M7.5 4V7.5l2.5 2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"
...
export function IconShield() {
    return (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            <path d="M7.5 1.5L2 3.5v3.75C2 10.5 4.5 13 7.5 13.5c3-.5 5.5-3 5.5-6.25V3.5L7.5 1.5z" stroke="currentColor"
                  strokeWidth="1.4" strokeLinejoin="round"/>
            <path d="M5 7.5l1.5 1.5 3-3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"
                  strokeLinejoin="round"/>
        </svg>
    )
}
...
export function IconStar() {
    return (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            <path
                d="M7.5 1.5l1.545 4.018H13.5l-3.436 2.455 1.309 4.027L7.5 9.59l-3.873 2.41 1.31-4.027L1.5 5.518h4.455L7.5 1.5z"
